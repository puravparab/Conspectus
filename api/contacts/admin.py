...
class ContactAdmin(admin.ModelAdmin):
	list_display = [
		"id", "name", "phone_number", "email", "image", "workplace", "job", "current_location_city",
		"importance", "relationship", "day_met", "original_location_city",
		"last_modified", "created_at"
	]

	fields = [
		"name", "phone_number", "email", "image", "workplace", "job", "current_location_city", "current_location_country",
